            ...
            <div class="classifiedDetailContent">
              ...
              <div class="classifiedInfo ">
                ...
                <ul class="classifiedInfoList">
                  ...
                  <li>
                    <strong>Marka</strong>&nbsp; <span> <?=$query['marka']?>&nbsp; </span>
                  </li>
                  <li>
                    <strong>Model</strong>&nbsp; <span> <?=$query['model']?>&nbsp; </span>
                  </li>
                  <li>
                    <strong>İşletim Sistemi</strong>&nbsp; <span class=""> <?=$query['os']?> </span>
                  </li>
                  <li>
                    <strong>Dahili Hafıza</strong>&nbsp; <span class=""> <?=$query['storage']?> </span>
                  </li>
                  <li>
                    <strong>Ekran Boyutu</strong>&nbsp; <span class=""> <?=$query['inches']?> </span>
                  </li>
                  <li>
                    <strong>RAM Bellek</strong>&nbsp; <span class=""> <?=$query['ram']?> </span>
                  </li>
                  <li>
                    <strong>Kamera</strong>&nbsp; <span class=""> <?=$query['backcamera']?> </span>
                  </li>
                  <li>
                    <strong>Ön Kamera</strong>&nbsp; <span class=""> <?=$query['frontcamera']?> </span>
                  </li>
                  <li>
                    <strong>Renk</strong>&nbsp; <span class=""> <?=$query['color']?> </span>
                  </li>
                  <li>
                    <strong>Garanti</strong>&nbsp; <span class=""> <?=$query['garanti']?> </span>
                  </li>
                  <li>
                    <strong>Kimden</strong>&nbsp; <span class="" style="color:#f00;" > <?=$query['fromwho']?> </span>
                  </li>
                  <li>
                    <strong>Takas</strong>&nbsp; <span> <?=$query['swap']?>&nbsp; </span>
                  </li>
                  <li>
                ...
                <div class="classifiedUserBox classified-owner-info" data-nosnippet="">
                  ...
                  <div class="classifiedUserContent ">
                    ...
                    <div class="getUserInfo halfBorder noBorder">
                      <p class="userRegistrationDate">Hesap Açma Tarihi <span>Haziran 2022</span>
                      </p>
                      <ul class="userLinks ">
                        <li>
        ...
        <div class="classifiedOtherDetails">
          ...
          <div id="classified-detail" class="mini-tab-content" style="display: block;">
            ...
            <div class="uiBox">
              ...
              <div class="uiBoxContainer classifiedDescription" id="classifiedProperties">
                <h3>Bağlantı</h3>
                <ul>
                  <li class=""> 3G</li>
                  <li class=""> 4G (LTE)</li>
                  <li class=""> 4.5G</li>
                  <li class=""> 5G</li>
                  <li class=""> Çift Sim Kart Desteği</li>
        ...
        <div class="ng-scope">
          ...
          <div class="content">
            ...
            <div class="breadcrumb" data-search-type="category/category_breadcrumb">
              ...
              <a class="ng-isolate-scope"> Cep Telefonu</a>
              <a class="ng-isolate-scope"> Modeller</a>
              <a class="ng-isolate-scope"> <?=$query['marka']?></a>
              <a class="ng-isolate-scope"> <?=$query['model']?></a>
            </div>
            ...
            <div class="info-section" ng-class="{'show-m-splash-price-history-icon':priceHistory.enableSplash}" ng-show="isActiveTab('info')">
              <ul class="classified-info-list">
                <li>
                  <strong>Fiyat</strong>
                  <span class="price"> <?=beforeCommas($query['ilanfiyat'])?> TL</span>
                </li>
                <li>
                  <strong> İlan Tarihi</strong>&nbsp; <span> <?=$query['ilan_date']?> </span>
                </li>
