            ...
            <div class="classifiedDetailContent">
              ...
              <div class="classifiedInfo ">
                ...
                <ul class="classifiedInfoList">
                  ...
                  <li>
                    <strong>Kategori</strong>&nbsp; <span> Ekran Kartı&nbsp; </span>
                  </li>
                  <li>
                  ...
                  <?php 
                    ...
                    if($os) {
                        echo "
                            <li>
                                <strong>Bellek Türü</strong>&nbsp; <span class=''> $os </span>
                            </li>
                        ";
                    }
                    ...
                    if($storage) {
                        echo "
                            <li>
                                <strong>Dahili Bellek</strong>&nbsp; <span class=''> $storage </span>
                            </li>
                        ";
                    }
                    ...
                    if($color) {
                        echo "
                            <li>
                                <strong>Model</strong>&nbsp; <span class=''> $color </span>
                            </li>
                        ";
                    }
        ...
        <div class="ng-scope">
          ...
          <div class="content">
            ...
            <div class="breadcrumb" data-search-type="category/category_breadcrumb">
              ...
              <a class="ng-isolate-scope"> Ekran Kartı</a>
              <a class="ng-isolate-scope"> Ekran Kartı</a>
